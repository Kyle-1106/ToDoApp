...
export class SelectTrainingDisciplineService {
  ...
  // getTrainingDisciplines(bodyPart:string):Observable<TrainingDiscipline[]>{
  //   const params=new HttpParams().set("query",bodyPart);
  //   return this.http.get<TrainingDiscipline[]>(this.url,{params}).pipe(
  //     catchError((error:any)=>{
  //       return throwError("種目の取得に失敗しました")
  //     })
  //     );
  // }
