...
const signup = async (req:any, res: any) => {
    try {
      ...
      const selectedUser:User=await userService.selectUser(userData);
      //JWT設定
      const signupData:Login={"id":selectedUser.id,"email":userData.email,"password":userData.password};
